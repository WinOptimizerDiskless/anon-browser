...
//      ProxyServer: TProxyServer; // Объявление поля для хранения экземпляра прокси-сервера
  public
    { Public declarations }
  end;
...
begin
// ProxyServer := TProxyServer.Create; // Создание экземпляра прокси-сервера
...
begin
//ProxyServer.Free; // Освобождение экземпляра прокси-сервера
end;
